...
- **Open Terminal** and **Open Ghostty** (when installed) launchers alongside Open Claude — off by default, enabled via a "Show terminal apps" toggle in Options (so the menu stays minimal for desktop-app users).
